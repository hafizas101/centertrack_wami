...
class VISdrone(GenericDataset):
  ...
  max_objs = 128
  cat_ids = {0:0, 1:1, 2:-9999, 3:-9999, 4:2, 5:3, 6:4, 7:-9999, 8:-9999, 9:5, 10:-9999, 11:-9999}
  cat_id_2_class_id ={1:1, 2:4, 3:5, 4:6, 5:6, 5:9}
  ...
  def save_results(self, results, save_dir):
    results_dir = os.path.join(save_dir, 'results_visdrone_tracking')
    ...
    for video in self.coco.dataset['videos']:
      ...
      for image_info in images:
        ...
        for i in range(len(results[img_id])):
          ...
          f.write('{} {} '.format(frame_id, track_id))
